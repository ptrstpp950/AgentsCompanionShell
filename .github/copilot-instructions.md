...
- By default, `bootstrap.sh` resolves its download base to `https://raw.githubusercontent.com/ptrstpp950/AgentsCompanionShell/master` unless overridden by `AGENTSCOMPANION_BASE_URL` or the GitHub repository/ref env vars.
